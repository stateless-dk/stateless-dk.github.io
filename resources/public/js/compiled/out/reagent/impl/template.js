...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28677__auto__,writer__28678__auto__,opt__28679__auto__){
return cljs.core._write.call(null,writer__28678__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__30027 = o;
(G__30027[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__30028__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__30028 = function (var_args){
var args = null;
...
while (G__30029__i < G__30029__a.length) {G__30029__a[G__30029__i] = arguments[G__30029__i + 0]; ++G__30029__i;}
  args = new cljs.core.IndexedSeq(G__30029__a,0,null);
} 
return G__30028__delegate.call(this,args);};
G__30028.cljs$lang$maxFixedArity = 0;
G__30028.cljs$lang$applyTo = (function (arglist__30030){
var args = cljs.core.seq(arglist__30030);
return G__30028__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__28040__auto__ = !((jsprops == null));
if(and__28040__auto__){
var and__28040__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__30033 = jsprops;
(G__30033["defaultValue"] = value);

(G__30033["onChange"] = ((function (G__30033,v,value,on_change){
return (function (p1__30032_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30032_SHARP_);
});})(G__30033,v,value,on_change))
);
...
var vec__30036 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30036,(0),null);
var id = cljs.core.nth.call(null,vec__30036,(1),null);
var class$ = cljs.core.nth.call(null,vec__30036,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30040 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30040 == null)){
} else {
var key_30041 = temp__4661__auto___30040;
(jsprops["key"] = key_30041);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30042 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30042["name"] = c);
...
var len__29223__auto___30047 = arguments.length;
var i__29224__auto___30048 = (0);
while(true){
if((i__29224__auto___30048 < len__29223__auto___30047)){
args__29230__auto__.push((arguments[i__29224__auto___30048]));

var G__30049 = (i__29224__auto___30048 + (1));
i__29224__auto___30048 = G__30049;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29231__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30045){
var G__30046 = cljs.core.first.call(null,seq30045);
var seq30045__$1 = cljs.core.next.call(null,seq30045);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30046,seq30045__$1);
});
...
break;
default:
var G__30052 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30052;
continue;
...
var n__28999__auto___30054 = a.length;
var i_30055 = (0);
while(true){
if((i_30055 < n__28999__auto___30054)){
(a[i_30055] = reagent.impl.template.as_element.call(null,(a[i_30055])));
...
var a = cljs.core.into_array.call(null,s);
var n__28999__auto___30057 = a.length;
var i_30058 = (0);
while(true){
if((i_30058 < n__28999__auto___30057)){
var val_30059 = (a[i_30058]);
if((cljs.core.vector_QMARK_.call(null,val_30059)) && ((reagent.impl.template.key_from_vec.call(null,val_30059) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30058] = reagent.impl.template.as_element.call(null,val_30059));

var G__30060 = (i_30058 + (1));
i_30058 = G__30060;
continue;
} else {
}
...
var ctx = ({});
var vec__30061 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30061,(0),null);
var derefed = cljs.core.nth.call(null,vec__30061,(1),null);
...
var G__30064 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30064) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30064){
...
//# sourceMappingURL=template.js.map?rel=1507552546058
