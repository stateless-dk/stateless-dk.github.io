...
var or__28052__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj35071 = {"detail":data};
return obj35071;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28040__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28040__auto__)){
var and__28040__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__35078 = cljs.core._EQ_;
var expr__35079 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35078.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35079))){
return ((function (pred__35078,expr__35079){
return (function (p1__35072_SHARP_){
return console.warn(p1__35072_SHARP_);
});
;})(pred__35078,expr__35079))
} else {
if(cljs.core.truth_(pred__35078.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35079))){
return ((function (pred__35078,expr__35079){
return (function (p1__35073_SHARP_){
return console.debug(p1__35073_SHARP_);
});
;})(pred__35078,expr__35079))
} else {
if(cljs.core.truth_(pred__35078.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35079))){
return ((function (pred__35078,expr__35079){
return (function (p1__35074_SHARP_){
return console.error(p1__35074_SHARP_);
});
;})(pred__35078,expr__35079))
} else {
return ((function (pred__35078,expr__35079){
return (function (p1__35075_SHARP_){
return console.log(p1__35075_SHARP_);
});
;})(pred__35078,expr__35079))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35082){
...
var eval_fn = cljs.core.get.call(null,map__35083__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35085_SHARP_);
});})(new_def))
);
...
return (function (p__35086){
var vec__35087 = p__35086;
var ky = cljs.core.nth.call(null,vec__35087,(0),null);
var v = cljs.core.nth.call(null,vec__35087,(1),null);
...
if(cljs.core.truth_((function (){var and__28040__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1507552550156
