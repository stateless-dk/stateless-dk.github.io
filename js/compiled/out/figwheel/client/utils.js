...
var or__7668__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34755 = {"detail":data};
return obj34755;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__7656__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__7656__auto__)){
var and__7656__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__34762 = cljs.core._EQ_;
var expr__34763 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34762.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34763))){
return ((function (pred__34762,expr__34763){
return (function (p1__34756_SHARP_){
return console.warn(p1__34756_SHARP_);
});
;})(pred__34762,expr__34763))
} else {
if(cljs.core.truth_(pred__34762.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34763))){
return ((function (pred__34762,expr__34763){
return (function (p1__34757_SHARP_){
return console.debug(p1__34757_SHARP_);
});
;})(pred__34762,expr__34763))
} else {
if(cljs.core.truth_(pred__34762.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34763))){
return ((function (pred__34762,expr__34763){
return (function (p1__34758_SHARP_){
return console.error(p1__34758_SHARP_);
});
;})(pred__34762,expr__34763))
} else {
return ((function (pred__34762,expr__34763){
return (function (p1__34759_SHARP_){
return console.log(p1__34759_SHARP_);
});
;})(pred__34762,expr__34763))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34766){
...
var eval_fn = cljs.core.get.call(null,map__34767__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34769_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34771,(0),null);
var v = cljs.core.nth.call(null,vec__34771,(1),null);
...
if(cljs.core.truth_((function (){var and__7656__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1507562214761
